...
import {getMostValuableCards} from '@/composables/useDashboardData'
...
onMounted(() => {
	cards.value = getMostValuableCards(3)
})
</script>
...
<template>
	...
	<div v-else class="flex flex-col items-center justify-center my-auto pb-8 gap-2">
		...
		/>
		<span class="text-contrast-400 text-xs w-[45%] text-center"
			>Mark your first cards as owned, and select a card vendor in the settings.</span
		>
	</div>
</template>
